...
void Piece::createRotationI()
{
    ...
    _blocksCoord = {
        // horizontal
        SDL_Point{0,2}, SDL_Point{1,2}, SDL_Point{2,2}, SDL_Point{3,2},
        // vertical
...
void Piece::createRotationL()
{
    ...
    _blocksCoord = {
        ...
        // left
        SDL_Point{0,1}, SDL_Point{1,1}, SDL_Point{1,2},SDL_Point{1,3},
        // up
        SDL_Point{2,1}, SDL_Point{0,2}, SDL_Point{1,2}, SDL_Point{2,2},
        // right
...
void Piece::createRotationZ()
{
    ...
    _blocksCoord = {
        // horizontal
        SDL_Point{0,1}, SDL_Point{1,1}, SDL_Point{1,2}, SDL_Point{2,2},
        // vertical
